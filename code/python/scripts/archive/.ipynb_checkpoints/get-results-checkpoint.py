...
drought_counts = xr.DataArray(np.zeros([102, 1155, 913]), dims=("time", "latitude", "longitude"))
...
drought_counts = drought_counts.assign_coords(time=pd.Series(drought_counts["time"].values).astype(str))
